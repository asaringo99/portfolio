  ...
  return (
    <div className="h-fit flex flex-col items-center justify-center bg-gradient-to-b from-teal-700 to-emerald-300">
      ...
      <div className="h-2/3 w-full flex justify-center flex-wrap px-12 md:px-20 2xl:px-52 md:pb-20">
        {data.map((d) => {
          return (
            <div className="h-16 w-16 m-2 md:h-28 md:w-28 md:m-8 shadow-2xl flex items-center justify-center bg-emerald-100 ring-1 ring-purple-900 transition-all ease-in-out duration-400 rounded-lg hover:bg-rose-400 hover:-translate-y-4 hover:scale-125 hover:rounded-full hover:ring-0 cursor-pointer forcus:cursor-auto">
              <Image
